...
// HealthMiddleware checks if the RPC client pool is available and returns API health.
func HealthMiddleware(rpcClientPool *rpc.RPCClientPool) gin.HandlerFunc {
...
// StatusMiddleware returns the status of the application based on internal checks.
func StatusMiddleware(rpcClientPool *rpc.RPCClientPool) gin.HandlerFunc {
	return func(c *gin.Context) {
